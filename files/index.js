...
app.post("/",function(req,res){  // trying to add new kidney to the user[0]
    ...
    users[0].kidneys.push({
        healthy: isHealthy   // where we r updating another kidney if we hv put ishealthy:tre a healthy kidney gets updated otherweise unhealthy kindney gets updated
    })
    res.json({
